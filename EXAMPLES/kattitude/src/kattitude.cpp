...
const char* SYMULATION_NAME="attit_k_v0.71c";
...
unsigned internal_log=7000;            ///< Długość logu. Nieobiektowo przekazywane do metody inicializacji zrodel
unsigned spatial_correlation_mode=50;  ///< Dystans korelacji(?). Nieobiektowo przekazywane do metody inicializacji zrodel
