...
protected:
    ...
    virtual int _calculate() //Zwraca 1, jeśli musial przeliczyc
    {
        ...
        if(table[0] == NULL && table[1] == NULL) return 1; //Sam nie liczy ale może klasa potomna
        ...
        {//LICZENIE PAR i SREDNICH
            ...
            if(table[1] == NULL || Pairs == 0) goto ERROR; //Nie da się albo nie trzeba dalej liczyc
...
//Raczej nieużywana (Bo bounds zwraca N=0) implementacja decyzji o wartości minimalnej i maksymalnej
    ...
    {
        //Jeśli nie ustawione to przyjmujemu typowy zakres korelacji
        min = -1;
        max = 1;
    }
