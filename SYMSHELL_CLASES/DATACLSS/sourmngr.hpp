...
public:
    ...
    /// @{
    virtual wb_dynarray<graph::series_info> make_series_info(int start, .../* ostatnia -1*/) = 0; //Z listy parametrów
    virtual wb_dynarray<graph::series_info>
