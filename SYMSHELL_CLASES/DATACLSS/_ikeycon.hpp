/// @file
/// @brief Private base for array class family.
...
namespace wbrtm { //WOJCIECH BORKOWSKI RUN TIME LIBRARY
    ...
    typedef void* 	                pix; ///< @brief Po co tak to nie wiem, jakaś stara historia.
    typedef unsigned long        size_t; ///< @brief ulong - ten sam rozmiar co pix?
    typedef unsigned long object_size_t; ///< @brief Powinien wystarczyć 32-bitowy, ale są rzuty.
