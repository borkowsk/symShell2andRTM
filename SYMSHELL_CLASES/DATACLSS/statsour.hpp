...
/// KLasa licząca podstawowe parametry statystyczne innego zrodla.
/// Parametry sa podawane w arbitralnej kolejności lub poprzez jednowartościowe źrodła pośrednie
