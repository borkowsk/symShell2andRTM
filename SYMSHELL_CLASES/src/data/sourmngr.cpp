...
int    sources_manager::set_info(size_t index,
            ...
            symshell2::config_point* fig) //Obiekt rysujący punkty
...
wb_dynarray<symshell2::graph::series_info> sources_manager::make_series_info(wb_dynarray<int> indexes)
{
    ...
    for(i=0;i<siz;i++)
        ...
        symshell2::graph::series_info pom(//nie ma zarządzać!
...
wb_dynarray<symshell2::graph::series_info> sources_manager::make_series_info(int start, .../* ostatnia -1*/)
